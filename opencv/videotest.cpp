...
int main() {
    ...
    string videoFilePath = "../videos/classroom_30FPS.mp4";
...
//#}
    ...
    // Load the cascades
    CascadeClassifier faceCascade("../models/haarcascade_frontalface_alt.xml");
    CascadeClassifier eyesCascade("../models/haarcascade_eye.xml"); // Try a different eye cascade
